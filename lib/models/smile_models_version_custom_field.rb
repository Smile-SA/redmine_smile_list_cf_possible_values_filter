# Smile - add methods to the VersionCustomField model
#
...
module Smile
  module Models
    module VersionCustomFieldOverride
      module FilterPossibleValues
        ...
        def self.prepended(base)
          ...
          last_postfix       = '< (SM::MO::VersionCustomFieldOverride::FilterPossibleValues)'
        ...
        # 3/ CustomField.possible_values OVERRIDEN extended, RM 2.6.10 OK
    ...
    end # module VersionCustomFieldOverride
  end # module Models
end # module Smile
