# Smile - add methods to the TimeEntryCustomField model
#
...
module Smile
  module Models
    module TimeEntryCustomFieldOverride
      module FilterPossibleValues
        ...
        def self.prepended(base)
          filter_possible_values_instance_methods = [
            ...
            :possible_values,                    # 3/ OVERRIDEN extended RM 4.0.0 OK
            :hidden_values,                      # 4/ OVERRIDEN ORM new  RM 4.0.0 OK
            :hidden_values_projects_exclusions,  # 5/ OVERRIDEN ORM new  RM 4.0.0 OK
          ]

          trace_prefix       = "#{' ' * (base.name.length + 12)}  --->  "
          last_postfix       = '< (SM::MO::TimeEntryCustomFieldOverride::FilterPossibleValues)'
          ...
          if missing_instance_methods.any?
            trace_first_prefix = "#{base.name} MISS inst_methods  "
          else
        ...
        # 3/ CustomField.possible_values OVERRIDEN extended, field added by plugin RM 4.0.0 OK
        ...
        # 4/ dynamic ORM field OVERRIDEN, field added by plugin RM 4.0.0 OK
        # Smile specific : cache added
        ...
        # 5/ dynamic ORM field OVERRIDEN, field added by plugin RM 4.0.0 OK
        # Smile specific : cache added
        # Smile specific : manage multiline string
    ...
    end # module TimeEntryCustomFieldOverride
  end # module Models
end # module Smile
